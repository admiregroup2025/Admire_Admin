...
const CreateItineriesPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    destination_images: [""],
    hotel_details: [{ type: "", roomType: "", price: "", discount: "" }],
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className={cardStyle}>
                ...
                <div key={index} className="p-4 border border-gray-700 rounded-lg">
                   <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        <div className="lg:col-span-2">
                            <label className={labelStyle}>Type (e.g., Standard)</label>
                            <input type="text" name="type" value={hotel.type} onChange={(e) => handleArrayChange(e, index, "hotel_details")} className={inputStyle}/>
                        </div>
                        <div className="lg:col-span-2">
            ...
            <button type="button" onClick={() => handleAddItem("hotel_details", { type: "", roomType: "", price: "", discount: "" })} className={`${buttonStyle} mt-4`}>
